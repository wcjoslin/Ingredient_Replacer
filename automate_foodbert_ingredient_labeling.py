...
def batch_query_openfoodfacts(ingredient_list, batch_size=100, sleep_time=60, output_path="foodbert_ingredient_categories.json"):
    results = {}
    failed = []
    ...
    if failed:
        with open("foodbert_ingredient_categories_failed.json", "w", encoding="utf-8") as f:
