...
def main():
    ...
    suggestic_foodbert_ingredient_swap(recipe_id, output_json_path="outputs/pre_diabetic_swap_result.json", error_log_path="outputs/pre_diabetic_swap_errors.json")
