...
with open("outputs/foodbert_ingredient_categories.json", "r", encoding="utf-8") as f:
    main_cats = json.load(f)

# Load LLM-generated categories
with open("outputs/foodbert_ingredient_categories_llm.json", "r", encoding="utf-8") as f:
